...
var apiKey = process.env.API_OPENWEATHER;
...
router.post('/add-city', async function(req, res, next){
  ...
  var data = request("GET", `https://api.openweathermap.org/data/2.5/weather?q=${req.body.newcity}&units=metric&lang=fr&appid=${apiKey}`) 
